...
export default function HeroSection({ orderUrl }) {
  ...
  return (
    <section className="relative min-h-screen bg-white overflow-hidden pt-24 flex items-center">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 py-12 md:py-20">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center max-w-7xl mx-auto">
          ...
          <div className="text-center lg:text-left space-y-6 md:space-y-8 animate-slide-in-up">
            {/* Premium Badge */}
            ...
            <h1 className="text-5xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-gray-900 leading-[1.1]">
              Calgary's Most
              <span className="block mt-2 bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent animate-gradient">
                Craveable
              </span>
              <span className="block mt-2">Fried Chicken</span>
            </h1>

            {/* Compelling Subheadline */}
            <p className="text-lg md:text-xl lg:text-2xl text-gray-700 font-bold leading-relaxed max-w-2xl mx-auto lg:mx-0">
            ...
            <p className="text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed max-w-xl mx-auto lg:mx-0">
              Hand-breaded fresh daily, marinated for 24 hours with our secret
              blend of spices. Made with 100% halal ingredients. This isn't just
              fast food{" "}
              <span className="font-bold text-primary">
                this is food done right.
              </span>
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-6 sm:gap-8 pt-6 md:pt-8">
              {/* 5 Star Rating */}
              <div className="flex flex-col items-center sm:items-start gap-2">
                <div className="flex">
                  {[...Array(5)].map((_, i) => (
                    <Star
                      key={i}
                      className="w-5 h-5 md:w-6 md:h-6 text-secondary fill-secondary"
                    />
                  ))}
                </div>
